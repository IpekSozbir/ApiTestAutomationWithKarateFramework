Feature: FA03 Kullanici Get request sonucu donen response test eder
  ...
  Scenario: TC03 Get request'e donen response'in beklenilen ozelliklerde olmasi gerekir
    ...
    # sadece rakamlarin varligini kontrol etmek icin '#regex ^[0-9]+$' bunu kullanirdik ama telefon numaralarinda
    #  alan kodu + ve - kullanildigi icin bunlarin bulunmasini ignore etmeliyiz
